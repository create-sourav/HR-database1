...
# 3. Match training feature columns
...
pred_class = RandomForest_tuned.predict(X_new_scaled)[0] ### gives 0 or 1
pred_prob  = RandomForest_tuned.predict_proba(X_new_scaled)[0][1]  # Attrition Probability of "Yes"

# 6. Decode label
predicted_label = encoders["Attrition"].inverse_transform([pred_class])[0]   ### gives Yes or No
